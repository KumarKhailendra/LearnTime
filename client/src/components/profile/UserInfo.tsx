    ...
    return (
        <form className="profile_info" onSubmit={handleSubmit}>
            ...
            <div className="form-group my-3">
                ...
                <input type="text" name="account" id="account" className="form-control" 
                defaultValue={auth.user.account} disabled={true} />
            </div>
            ...
            <div className="form-group my-3">
                ...
                <div className="pass">
                    <input type={typePass ? "text" : "password"} name="password" id="password" className="form-control" 
                    value={password} onChange={handleChangeInput} disabled={auth.user.type !== 'register'} />
            ...
            <div className="form-group my-3">
                ...
                <div className="pass">
                    <input type={typeCfPass ? "text" : "password"} name="cf_password" id="cf_password" className="form-control" 
                    value={cf_password} onChange={handleChangeInput} disabled={auth.user.type !== 'register'} />
